...
//#define DEFAULT_SPEED_COEFFICIENT 32768  // Default for SPEED_COEFFICIENT 1.0f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case 16384 = 1.0 * 2^14
#define DEFAULT_SPEED_COEFFICIENT 16384 
#define DEFAULT_STEER_COEFFICIENT 4915.2 // Defualt for STEER_COEFFICIENT 0.5f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case  8192 = 0.5 * 2^14. If you do not want any steering, set it to 0.
...
//#define USART_BRAKE_ENABLE            // Use Uart speed commmannd to act as brake, when forward & commandBrake = 1 (-speed = brake) When backwards commandBrake = 0, positive speed = brake (+speed=brake) 
// #define TANK_STEERING              // use for tank steering, each input controls each wheel
// #define SUPPORT_BUTTONS_LEFT       // use left sensor board cable for button inputs.  Disable DEBUG_SERIAL_USART2!
// #define SUPPORT_BUTTONS_RIGHT      // use right sensor board cable for button inputs. Disable DEBUG_SERIAL_USART3!
#endif
